...
interface DonationContextType {
  ...
  miningPoints: number
  setMiningPoints: (points: number | ((prev: number) => number)) => void
  isConnected: boolean
...
export function DonationProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (isNewDay(lastTaskDate)) {
      console.log("[v0] New day detected - resetting daily tasks and mining points")
      loadedData.dailyTasksCompleted = 0
      loadedData.miningPoints = 0
    ...
    setMiningPoints(loadedData.miningPoints)
  ...
  }, [withdrawalPoints, miningPoints, streak, totalEarned, dailyTasksCompleted, lastLoginDate, isDataLoaded])
