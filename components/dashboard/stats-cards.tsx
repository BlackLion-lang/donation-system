...
import { Star, Users, Trophy, Flame, Pickaxe } from "lucide-react"
  ...
  return (
    ...
    >
      {isWithdrawing || isPending ? "Withdrawing..." : 
       withdrawalPoints >= 75 ?  userBalance <= 0 ? "No Balance" : `Withdraw($${userBalance})` : 
       `${75 - withdrawalPoints} more points needed`}
    </Button>
  )
}
